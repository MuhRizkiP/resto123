...
<div class="row">
    <div class="col-4">
        ...
        <form action="?page=transaksi-detail-store" method="post">
            ...
            <input type="number" name="jumlah_menu" class="form-control text-center mb-2" placeholder="Jumlah Menu" required>
                ...
                <tr>
                    ...
                    <form action="?page=transaksi_detail-update" method="POST">
                        <td width="10%">
                            ...
                            <input name="harga_menu" value="RP. <?= number_format($hasil_select_dt->harga_menu, 2, ".", ".") ?>" type="text" hidden>
                            <input style="text-align: center;" class="form-control" type="number" min="1" name="jumlah_menu" value="<?= $hasil_select_dt->jumlah_menu ?>">
